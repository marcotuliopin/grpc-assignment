...
class StoreServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.EndExecution = channel.unary_unary(
                '/store.StoreService/EndExecution',
                request_serializer=store__pb2.EndExecutionRequest.SerializeToString,
                response_deserializer=store__pb2.EndExecutionResponse.FromString,
                _registered_method=True)
...
def add_StoreServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'EndExecution': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=store__pb2.EndExecutionRequest.FromString,
                    response_serializer=store__pb2.EndExecutionResponse.SerializeToString,
            ),
    }
...
class StoreService(object):
    ...
    def EndExecution(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/store.StoreService/EndExecution',
            store__pb2.EndExecutionRequest.SerializeToString,
            store__pb2.EndExecutionResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
